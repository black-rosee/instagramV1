...
# Logo
___logo___ = (f"""{H}    _    ____   ____ _____ ____    _
{H}   / \  |  _ \ / ___| ____/ ___|  / \
{H}  / _ \ | |_) | |  _|  _|| |     / _ \
{B} / ___ \|  _ <| |_| | |__| |___ / ___ \
{B}/_/   \_\_| \_\\____|_____\____/_/   \_\


{K}[{P}•{K}]{P}════════════════════════════════════
{K}[{P}>{K}]{P}☆☆☆☆https://github.com/black-rosee☆☆☆☆
{K}[{P}>{K}]{P}ZONA CRACKER INSTAGRAM
{K}[{P}>{K}]{P}ROSE OF DARKNESS
{K}[{P}•{K}]{P}════════════════════════════════════
""")
# Login Cookie
def ___login___():
