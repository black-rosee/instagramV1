...
{K}[{P}•{K}]{P}╔════════════════════════════════════════════╗
{H}[{P}>{H}]{P} AUTHOR    :   ROSE OF DARKNESS
{H}[{P}>{H}]{P} FACEBOOK  :   Ǝ.ちᏎち ツ︻ヸテணייי一一一
{H}[{P}>{H}]{P} TEAM CODE :   ARGECA 0910 CYBER TEAM
{H}[{P}>{H}]{P}        JANGAN DI SALAH GUNAKAN OKE TERIMA KASIH
{K}[{P}•{K}]{P}╚════════════════════════════════════════════╝
""")
# Login Cookie
def ___login___():
